...
task("balance", "Prints an account's balance")
    ...
    .setAction(async (params, { web3 }) => {
        const { account } = params;
        await balance(account, { web3 });
    });
...
task("grantRole", "Grant role to account")
    .addParam("account", "The account's address")
...
const config: HardhatUserConfig = {
    ...
    networks: {
        ...
        mumbai: {
            url: RPCURLPolygonMumbai,
            chainId: 80001,
            accounts: [privateKeyMaticTest],
        },
        matic: {
